...
For final implementation, treat production token values in `/app/styles/theme.css` as source-of-truth.
...
4. Confirm no regression on homepage hero and primary conversion surfaces.
