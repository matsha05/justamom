...
<DownloadCard
  title="A Different Kind of New Year"
  description="A printable guided reset for moms—designed to help you start January from identity rather than expectation."
  href="/downloads/a-different-kind-of-new-year"
  filePath="/downloads/a-different-kind-of-new-year.pdf"
  fileType="PDF"
