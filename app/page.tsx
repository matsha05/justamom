          ...
          <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="space-y-6">
              ...
              <p className="text-body-lg text-[var(--color-ink-soft)]">
                Short reflections on motherhood, identity, and quiet faith for women
                who want to live from a steadier place.
              </p>
          ...
          <div className="grid gap-14 lg:grid-cols-[1fr_2fr] lg:gap-16">
            <div className="space-y-4">
              ...
              <p className="text-body text-[var(--color-ink-soft)]">
                Twice each month I send A Note for Moms - a small, steady reminder
                for mothers who feel the noise. These are the notes.
              </p>
            </div>
